"""Pull filings for the defense-tech cohort.

Run from repo root:
    python3 -m verticals.public_co.configs._defense_pull
"""
...
from verticals.public_co.defense_cohort import COHORT, CUTOFF
