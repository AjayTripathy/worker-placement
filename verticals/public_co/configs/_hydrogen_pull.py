"""Pull filings for the hydrogen / fuel-cell cohort.

Run from repo root:
    python3 -m verticals.public_co.configs._hydrogen_pull
"""
...
from verticals.public_co.hydrogen_cohort import COHORT, CUTOFF
