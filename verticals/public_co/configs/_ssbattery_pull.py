"""Pull filings for the solid-state battery cohort.

Run from repo root:
    python3 -m verticals.public_co.configs._ssbattery_pull
"""
...
from verticals.public_co.ssbattery_cohort import COHORT, CUTOFF
