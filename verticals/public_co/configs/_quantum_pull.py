"""Pull filings for the quantum-computing cohort.

Run from repo root:
    python3 -m verticals.public_co.configs._quantum_pull
"""
...
from verticals.public_co.quantum_cohort import COHORT, CUTOFF
