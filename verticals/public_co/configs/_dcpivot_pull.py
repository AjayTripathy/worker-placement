"""Pull filings for the AI-DC crypto-pivot cohort.

Run from repo root:
    python3 -m verticals.public_co.configs._dcpivot_pull
"""
...
from verticals.public_co.dcpivot_cohort import COHORT, CUTOFF
