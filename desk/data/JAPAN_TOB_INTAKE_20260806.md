# Japan TOB / take-private lane — intake 2026-08-06

USD/JPY 158.39 at run. Announced book (spreads) and anticipatory book (fingerprints) are separate and are never summed.
...
|---|---|---|---|---|---|---|---|---|---|
| 4171 | グローバルＩ | 株式会社ユーザベース | 1,680 | 1,665 | +0.90 | +30 | 11 | THIN | DATED_STEP2 |
| 8283 | ＰＡＬＴＡＣ | メディパル | 6,650 | 6,625 | +0.38 | +20 | 7 | QUOTABLE | DATED_STEP2 |
| 2162 | ｎｍｓ　ＨＤ | ワールドＨＤ | 540 | 536 | +0.65 | +9 | 26 | THIN | DATED_STEP2 |
| 2997 | Ｇ－ストレージ王 | エリアリンク | 1,340 | 1,336 | +0.34 | +6 | 22 | QUOTABLE_SMALL | DATED |
| 3276 | ＪＰＭＣ | 株式会社Amsterdam1及び | 2,250 | 2,244 | +0.24 | +2 | 50 | QUOTABLE | DATED |
| 7523 | アールビバン | 株式会社Orsay | 1,900 | 1,898 | +0.10 | +2 | 26 | THIN | DATED |
| 4722 | フューチャー | 合同会社キーウェスト・ネットワー | 2,451 | 2,447 | +0.16 | +1 | 42 | QUOTABLE | DATED |
...
- **Timing**: DATED_STEP2 — step-2 cash-out effective 2026-08-17 (11d); delisting 2026-08-13
...
- **JPY add**: a ¥1,000,000 clip here is $6,314 of ADDITIONAL unhedged JPY on top of the existing Japan book.
...
- **Terms**: offer ¥6,650 vs spot ¥6,625 = +0.38% gross
- **Timing**: DATED_STEP2 — step-2 cash-out effective 2026-08-13 (7d); delisting 2026-08-10
- **Minimum-tender condition**: no floor parsed — treat as UNVERIFIED, not as 'no condition'
- **Squeeze-out**: step 2 = 株式売渡請求 (Companies Act 179): available only at >=90% voting; ~1-2 months post-settlement, no EGM.
- **Liquidity (thin-print gate)**: QUOTABLE — 20d median turnover ¥725M/day
- **JPY add**: a ¥1,000,000 clip here is $6,314 of ADDITIONAL unhedged JPY on top of the existing Japan book.
...
- **Timing**: DATED_STEP2 — step-2 cash-out effective 2026-09-01 (26d); delisting 2026-08-28
- **Minimum-tender condition**: no floor parsed — treat as UNVERIFIED, not as 'no condition'
- **Squeeze-out**: step 2 = 株式売渡請求 (Companies Act 179): available only at >=90% voting; ~1-2 months post-settlement, no EGM.
...
- **Timing**: DATED — cash expected 2026-08-28 (22d)
...
- **Timing**: DATED — cash expected 2026-09-25 (50d)
...
- **Squeeze-out**: step 2 = 株式併合 reverse split; requires an EGM special resolution, so a NON-tendering holder waits ~3-5 months beyond tender settlement for the same cash.
- **Liquidity (thin-print gate)**: QUOTABLE — 20d median turnover ¥242M/day
- **JPY add**: a ¥1,000,000 clip here is $6,314 of ADDITIONAL unhedged JPY on top of the existing Japan book.
...
- **Timing**: DATED — cash expected 2026-09-01 (26d)
...
- **Terms**: offer ¥2,451 vs spot ¥2,447 = +0.16% gross
- **Timing**: DATED — cash expected 2026-09-17 (42d)
...
- **Squeeze-out**: step 2 = 株式併合 reverse split; requires an EGM special resolution, so a NON-tendering holder waits ~3-5 months beyond tender settlement for the same cash.
- **Liquidity (thin-print gate)**: QUOTABLE — 20d median turnover ¥2956M/day
- **JPY add**: a ¥1,000,000 clip here is $6,314 of ADDITIONAL unhedged JPY on top of the existing Japan book.
- **Taxable**: tender proceeds are a disposition, not a rollover — short-term gain unless held >1y. On a +0.16% gross spread the after-tax return at a ~50% marginal rate is roughly half the headline.
...
- **Timing**: TIMING_UNBOUNDED — offer is PRE-CONDITIONAL (competition clearance etc.); the commencement date is NOT fixed, so a computed annualized number would be manufactured. Gross only. SCENARIO ONLY: at 146d to cash (from the bidder's own guided commencement window (2026-11-25)) the gross +1.63% annualizes to +4%/yr — an assumption, NOT a term of the offer, and it goes to zero if the conditions fail.
...
- **Squeeze-out**: step 2 = 株式併合 reverse split; requires an EGM special resolution, so a NON-tendering holder waits ~3-5 months beyond tender settlement for the same cash.
- **Liquidity (thin-print gate)**: QUOTABLE — 20d median turnover ¥584M/day
- **JPY add**: a ¥1,000,000 clip here is $6,314 of ADDITIONAL unhedged JPY on top of the existing Japan book.
...
- 3676 デジハＨＤ — TIMING_UNPARSED; QUOTABLE_SMALL; terms NOT parsed. 株式会社デジタルハーツホールディングス（証券コード：3676）に対する公開買付けの開始に関するお知らせ
