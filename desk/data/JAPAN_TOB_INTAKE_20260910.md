# Japan TOB / take-private lane — intake 2026-09-10

USD/JPY 154.02 at run. Announced book (spreads) and anticipatory book (fingerprints) are separate and are never summed.
...
57 deals tracked in the window; 19 live; 4 with a computable spread.

| target | name | bidder | offer ¥ | spot ¥ | gross % | ann. % | days | liquidity | timing |
|---|---|---|---|---|---|---|---|---|---|
| 4722 | フューチャー | 合同会社キーウェスト・ネットワー | 2,451 | 2,422 | +1.20 | +62 | 7 | QUOTABLE | DATED |
| 3276 | ＪＰＭＣ | 株式会社Amsterdam1及び | 2,250 | 2,246 | +0.18 | +4 | 15 | QUOTABLE | DATED |
| 9110 | ユナイテド海 | 郵船 | 10,600 | 10,480 | +1.15 | — | — | QUOTABLE | TIMING_UNBOUNDED |
| 2371 | カカクコム | ＬＩＮＥヤフー | 3,450 | 3,695 | -6.63 | — | — | QUOTABLE | TIMING_UNBOUNDED |

### 4722 フューチャー — OPEN

- **Bidder / purpose**: 合同会社キーウェスト・ネットワーク · GO_PRIVATE · target opinion not parsed
- **Terms**: offer ¥2,451 vs spot ¥2,422 = +1.20% gross
- **Timing**: DATED — cash expected 2026-09-17 (7d)
...
- **Liquidity (thin-print gate)**: QUOTABLE — 20d median turnover ¥1820M/day
- **JPY add**: a ¥1,000,000 clip here is $6,493 of ADDITIONAL unhedged JPY on top of the existing Japan book.
- **Taxable**: tender proceeds are a disposition, not a rollover — short-term gain unless held >1y. On a +1.20% gross spread the after-tax return at a ~50% marginal rate is roughly half the headline.
...
- **Terms**: offer ¥2,250 vs spot ¥2,246 = +0.18% gross
- **Timing**: DATED — cash expected 2026-09-25 (15d)
...
- **Squeeze-out**: step 2 = 株式併合 reverse split; requires an EGM special resolution, so a NON-tendering holder waits ~3-5 months beyond tender settlement for the same cash.
- **Liquidity (thin-print gate)**: QUOTABLE — 20d median turnover ¥440M/day
- **JPY add**: a ¥1,000,000 clip here is $6,493 of ADDITIONAL unhedged JPY on top of the existing Japan book.
...
- **Timing**: TIMING_UNBOUNDED — offer is PRE-CONDITIONAL (competition clearance etc.); the commencement date is NOT fixed, so a computed annualized number would be manufactured. Gross only. SCENARIO ONLY: at 111d to cash (from the bidder's own guided commencement window (2026-11-25)) the gross +1.15% annualizes to +4%/yr — an assumption, NOT a term of the offer, and it goes to zero if the conditions fail.
...
- **Squeeze-out**: step 2 = 株式併合 reverse split; requires an EGM special resolution, so a NON-tendering holder waits ~3-5 months beyond tender settlement for the same cash.
- **Liquidity (thin-print gate)**: QUOTABLE — 20d median turnover ¥1131M/day
- **JPY add**: a ¥1,000,000 clip here is $6,493 of ADDITIONAL unhedged JPY on top of the existing Japan book.
...
- **Squeeze-out**: step 2 = 株式併合 reverse split; requires an EGM special resolution, so a NON-tendering holder waits ~3-5 months beyond tender settlement for the same cash.
- **Liquidity (thin-print gate)**: QUOTABLE — 20d median turnover ¥762M/day
- **JPY add**: a ¥1,000,000 clip here is $6,493 of ADDITIONAL unhedged JPY on top of the existing Japan book.
- **Taxable**: tender proceeds are a disposition, not a rollover — short-term gain unless held >1y. On a -6.63% gross spread the after-tax return at a ~50% marginal rate is roughly half the headline.
...
- **2162 ｎｍｓ　ＨＤ** — headline +0.37% vs offer ¥540. not quotable: last print 14d old — spread struck on a stale tape
- **4171 グローバルＩ** — headline +0.90% vs offer ¥1,680. not quotable: last print 29d old — spread struck on a stale tape
...
- 7743 シード — TIMING_UNPARSED; QUOTABLE; terms NOT parsed. ラックスシェア・プレシジョン・ケイマン・リミテッドによる当社株式に対する公開買付けに関する賛同の意見表明及び応募推奨に関するお知らせ
...
- 4420 イーソル — TIMING_UNPARSED; QUOTABLE; terms NOT parsed. 株式会社BCJ-110によるイーソル株式会社（証券コード：4420）の普通株式に対する公開買付けの開始に関するお知らせ
- 7475 アルビス — TIMING_UNPARSED; LIMIT_LOCKED; terms NOT parsed. 株式会社ライフコーポレーションによる当社株式に対する 公開買付けに関する賛同の意見表明及び応募推奨のお知らせ
...
- Inputs: annual-report balance sheet, price cached 21d ago — screen-grade, not valuation-grade. 大株主 table reconciled against 1,418,000 issued shares, unit 百株
...
- Inputs: annual-report balance sheet, price cached 21d ago — screen-grade, not valuation-grade. 大株主 table reconciled against 15,637,144 issued shares, unit 千株
...
- Inputs: annual-report balance sheet, price cached 21d ago — screen-grade, not valuation-grade. 大株主 table reconciled against 22,500,000 issued shares, unit 千株
...
- Inputs: annual-report balance sheet, price cached 21d ago — screen-grade, not valuation-grade. 大株主 table reconciled against 15,630,000 issued shares, unit 千株
...
- Minority float ~49% of shares; the controller needs to reach 90% to squeeze out without an EGM.
- Inputs: annual-report balance sheet, price cached 21d ago — screen-grade, not valuation-grade. 大株主 table reconciled against 9,000,000 issued shares, unit 千株
...
- Inputs: annual-report balance sheet, price cached 21d ago — screen-grade, not valuation-grade. 大株主 table reconciled against 38,315,000 issued shares, unit 千株
...
- Inputs: annual-report balance sheet, price cached 21d ago — screen-grade, not valuation-grade. 大株主 table reconciled against 15,673,885 issued shares, unit 千株
...
- Inputs: annual-report balance sheet, price cached 21d ago — screen-grade, not valuation-grade. 大株主 table reconciled against 29,990,400 issued shares, unit 株
...
- Minority float ~49% of shares; the controller needs to reach 90% to squeeze out without an EGM.
- Inputs: annual-report balance sheet, price cached 21d ago — screen-grade, not valuation-grade. 大株主 table reconciled against 273,768,922 issued shares, unit 千株
...
- Inputs: annual-report balance sheet, price cached 21d ago — screen-grade, not valuation-grade. 大株主 table reconciled against 135,452,804 issued shares, unit 千株
