# Japan TOB / take-private lane — intake 2026-08-25

USD/JPY 159.25 at run. Announced book (spreads) and anticipatory book (fingerprints) are separate and are never summed.
...
47 deals tracked in the window; 13 live; 6 with a computable spread.

| target | name | bidder | offer ¥ | spot ¥ | gross % | ann. % | days | liquidity | timing |
|---|---|---|---|---|---|---|---|---|---|
| 7523 | アールビバン | 株式会社Orsay | 1,900 | 1,879 | +1.12 | +58 | 7 | THIN | DATED |
| 2162 | ｎｍｓ　ＨＤ | ワールドＨＤ | 540 | 537 | +0.56 | +29 | 7 | THIN | DATED_STEP2 |
| 4722 | フューチャー | 合同会社キーウェスト・ネットワー | 2,451 | 2,448 | +0.12 | +2 | 23 | QUOTABLE | DATED |
| 3276 | ＪＰＭＣ | 株式会社Amsterdam1及び | 2,250 | 2,247 | +0.13 | +2 | 31 | QUOTABLE | DATED |
...
- **Timing**: DATED — cash expected 2026-09-01 (7d)
...
- **Liquidity (thin-print gate)**: THIN — 20d median turnover ¥8.7M/day — a quoted spread here is not fillable at size; this is a delisting stub, not a position
...
- **Timing**: DATED_STEP2 — step-2 cash-out effective 2026-09-01 (7d); delisting 2026-08-28
...
- **Liquidity (thin-print gate)**: THIN — 20d median turnover ¥6.7M/day — a quoted spread here is not fillable at size; this is a delisting stub, not a position
- **JPY add**: a ¥1,000,000 clip here is $6,280 of ADDITIONAL unhedged JPY on top of the existing Japan book.
...
- **Terms**: offer ¥2,451 vs spot ¥2,448 = +0.12% gross
- **Timing**: DATED — cash expected 2026-09-17 (23d)
...
- **Squeeze-out**: step 2 = 株式併合 reverse split; requires an EGM special resolution, so a NON-tendering holder waits ~3-5 months beyond tender settlement for the same cash.
- **Liquidity (thin-print gate)**: QUOTABLE — 20d median turnover ¥2887M/day
- **JPY add**: a ¥1,000,000 clip here is $6,280 of ADDITIONAL unhedged JPY on top of the existing Japan book.
- **Taxable**: tender proceeds are a disposition, not a rollover — short-term gain unless held >1y. On a +0.12% gross spread the after-tax return at a ~50% marginal rate is roughly half the headline.
...
- **Timing**: DATED — cash expected 2026-09-25 (31d)
...
- **Squeeze-out**: step 2 = 株式併合 reverse split; requires an EGM special resolution, so a NON-tendering holder waits ~3-5 months beyond tender settlement for the same cash.
- **Liquidity (thin-print gate)**: QUOTABLE — 20d median turnover ¥1209M/day
- **JPY add**: a ¥1,000,000 clip here is $6,280 of ADDITIONAL unhedged JPY on top of the existing Japan book.
...
- **Squeeze-out**: step 2 = 株式併合 reverse split; requires an EGM special resolution, so a NON-tendering holder waits ~3-5 months beyond tender settlement for the same cash.
- **Liquidity (thin-print gate)**: QUOTABLE — 20d median turnover ¥991M/day
- **JPY add**: a ¥1,000,000 clip here is $6,280 of ADDITIONAL unhedged JPY on top of the existing Japan book.
...
- **8283 ＰＡＬＴＡＣ** — headline +0.30% vs offer ¥6,650. not quotable: last print 18d old — spread struck on a stale tape
- **4171 グローバルＩ** — headline +0.90% vs offer ¥1,680. not quotable: last print 13d old — spread struck on a stale tape
