# Japan TOB / take-private lane — intake 2026-09-03

USD/JPY 156.39 at run. Announced book (spreads) and anticipatory book (fingerprints) are separate and are never summed.
...
|---|---|---|---|---|---|---|---|---|---|
| 4722 | フューチャー | 合同会社キーウェスト・ネットワー | 2,451 | 2,447 | +0.16 | +4 | 14 | QUOTABLE | DATED |
| 3276 | ＪＰＭＣ | 株式会社Amsterdam1及び | 2,250 | 2,246 | +0.18 | +3 | 22 | QUOTABLE | DATED |
...
- **Timing**: DATED — cash expected 2026-09-17 (14d)
...
- **Liquidity (thin-print gate)**: QUOTABLE — 20d median turnover ¥2150M/day
- **JPY add**: a ¥1,000,000 clip here is $6,394 of ADDITIONAL unhedged JPY on top of the existing Japan book.
...
- **Timing**: DATED — cash expected 2026-09-25 (22d)
...
- **Timing**: TIMING_UNBOUNDED — offer is PRE-CONDITIONAL (competition clearance etc.); the commencement date is NOT fixed, so a computed annualized number would be manufactured. Gross only. SCENARIO ONLY: at 118d to cash (from the bidder's own guided commencement window (2026-11-25)) the gross +1.15% annualizes to +4%/yr — an assumption, NOT a term of the offer, and it goes to zero if the conditions fail.
...
- **Squeeze-out**: step 2 = 株式併合 reverse split; requires an EGM special resolution, so a NON-tendering holder waits ~3-5 months beyond tender settlement for the same cash.
- **Liquidity (thin-print gate)**: QUOTABLE — 20d median turnover ¥887M/day
- **JPY add**: a ¥1,000,000 clip here is $6,394 of ADDITIONAL unhedged JPY on top of the existing Japan book.
...
- **2162 ｎｍｓ　ＨＤ** — headline +0.37% vs offer ¥540. not quotable: last print 7d old — spread struck on a stale tape
- **8283 ＰＡＬＴＡＣ** — headline +0.30% vs offer ¥6,650. not quotable: last print 27d old — spread struck on a stale tape
- **4171 グローバルＩ** — headline +0.90% vs offer ¥1,680. not quotable: last print 22d old — spread struck on a stale tape
