# Japan TOB / take-private lane — intake 2026-09-11

USD/JPY 154.26 at run. Announced book (spreads) and anticipatory book (fingerprints) are separate and are never summed.
...
48 deals tracked in the window; 14 live; 5 with a computable spread.

| target | name | bidder | offer ¥ | spot ¥ | gross % | ann. % | days | liquidity | timing |
|---|---|---|---|---|---|---|---|---|---|
| 3276 | ＪＰＭＣ | 株式会社Amsterdam1及び | 2,250 | 2,248 | +0.09 | +2 | 14 | QUOTABLE | DATED |
| 7523 | アールビバン | 株式会社Orsay | 1,900 | 1,875 | +1.33 | — | -10 | THIN | EXPIRED_NO_RESULT |
| 2997 | Ｇ－ストレージ王 | エリアリンク | 1,340 | 1,323 | +1.28 | — | -14 | THIN | EXPIRED_NO_RESULT |
| 9110 | ユナイテド海 | 郵船 | 10,600 | 10,480 | +1.15 | — | — | QUOTABLE | TIMING_UNBOUNDED |
| 2371 | カカクコム | Kamgras1株式会社 | 3,450 | 3,796 | -9.12 | — | — | QUOTABLE | TIMING_UNBOUNDED |

### 3276 ＪＰＭＣ — OPEN

- **Bidder / purpose**: 株式会社Amsterdam1及び株式会社Amsterdam2 · GO_PRIVATE · target opinion not parsed
- **Terms**: offer ¥2,250 vs spot ¥2,248 = +0.09% gross
- **Timing**: DATED — cash expected 2026-09-25 (14d)
...
- **Liquidity (thin-print gate)**: QUOTABLE — 20d median turnover ¥441M/day
- **JPY add**: a ¥1,000,000 clip here is $6,483 of ADDITIONAL unhedged JPY on top of the existing Japan book.
- **Taxable**: tender proceeds are a disposition, not a rollover — short-term gain unless held >1y. On a +0.09% gross spread the after-tax return at a ~50% marginal rate is roughly half the headline.
...
- **Terms**: offer ¥1,900 vs spot ¥1,875 = +1.33% gross
- **Timing**: EXPIRED_NO_RESULT — parsed settlement 2026-09-01 is in the past but no result disclosure seen — stale terms or a missed crawl day, do NOT price this
...
- **Squeeze-out**: step 2 = 株式併合 reverse split; requires an EGM special resolution, so a NON-tendering holder waits ~3-5 months beyond tender settlement for the same cash.
- **Liquidity (thin-print gate)**: THIN — 20d median turnover ¥5.9M/day — a quoted spread here is not fillable at size; this is a delisting stub, not a position
- **JPY add**: a ¥1,000,000 clip here is $6,483 of ADDITIONAL unhedged JPY on top of the existing Japan book.
- **Taxable**: tender proceeds are a disposition, not a rollover — short-term gain unless held >1y. On a +1.33% gross spread the after-tax return at a ~50% marginal rate is roughly half the headline.
...
- **Terms**: offer ¥1,340 vs spot ¥1,323 = +1.28% gross
- **Timing**: EXPIRED_NO_RESULT — parsed settlement 2026-08-28 is in the past but no result disclosure seen — stale terms or a missed crawl day, do NOT price this
...
- **Squeeze-out**: step 2 = 株式併合 reverse split; requires an EGM special resolution, so a NON-tendering holder waits ~3-5 months beyond tender settlement for the same cash.
- **Liquidity (thin-print gate)**: THIN — 20d median turnover ¥7.7M/day — a quoted spread here is not fillable at size; this is a delisting stub, not a position
- **JPY add**: a ¥1,000,000 clip here is $6,483 of ADDITIONAL unhedged JPY on top of the existing Japan book.
- **Taxable**: tender proceeds are a disposition, not a rollover — short-term gain unless held >1y. On a +1.28% gross spread the after-tax return at a ~50% marginal rate is roughly half the headline.
...
- **Timing**: TIMING_UNBOUNDED — offer is PRE-CONDITIONAL (competition clearance etc.); the commencement date is NOT fixed, so a computed annualized number would be manufactured. Gross only. SCENARIO ONLY: at 110d to cash (from the bidder's own guided commencement window (2026-11-25)) the gross +1.15% annualizes to +4%/yr — an assumption, NOT a term of the offer, and it goes to zero if the conditions fail.
...
- **Squeeze-out**: step 2 = 株式併合 reverse split; requires an EGM special resolution, so a NON-tendering holder waits ~3-5 months beyond tender settlement for the same cash.
- **Liquidity (thin-print gate)**: QUOTABLE — 20d median turnover ¥1073M/day
- **JPY add**: a ¥1,000,000 clip here is $6,483 of ADDITIONAL unhedged JPY on top of the existing Japan book.
...
- **Squeeze-out**: step 2 = 株式併合 reverse split; requires an EGM special resolution, so a NON-tendering holder waits ~3-5 months beyond tender settlement for the same cash.
- **Liquidity (thin-print gate)**: QUOTABLE — 20d median turnover ¥783M/day
- **JPY add**: a ¥1,000,000 clip here is $6,483 of ADDITIONAL unhedged JPY on top of the existing Japan book.
- **Taxable**: tender proceeds are a disposition, not a rollover — short-term gain unless held >1y. On a -9.12% gross spread the after-tax return at a ~50% marginal rate is roughly half the headline.
...
- **2162 ｎｍｓ　ＨＤ** — headline +0.37% vs offer ¥540. not quotable: last print 15d old — spread struck on a stale tape
- **4171 グローバルＩ** — headline +0.90% vs offer ¥1,680. not quotable: last print 30d old — spread struck on a stale tape

### Live but not priceable

- 3480 ジェイ・エス・ビー — TIMING_UNPARSED; STALE; terms NOT parsed. Ｕｒｓａ ４株式会社による当社株券等に対する公開買付けの結果並びに親会社及び主要株主である筆頭株主の異動に関するお知らせ
...
- 3989 Ｇ－シェアリングＴ — TIMING_UNPARSED; QUOTABLE; terms NOT parsed. MP-2606株式会社による当社株券等に対する公開買付けに関する賛同及び応募推奨の意見表明のお知らせ
- 7475 アルビス — TIMING_UNPARSED; QUOTABLE_SMALL; terms NOT parsed. 株式会社ライフコーポレーションによる当社株式に対する 公開買付けに関する賛同の意見表明及び応募推奨のお知らせ
- 4477 ＳＢＩ — TIMING_UNPARSED; QUOTABLE; terms NOT parsed. （訂正）公開買付届出書の訂正届出書の提出に伴う「BASE株式会社株式（証券コード：4477）に対する公開買付けの開始（略）」等の訂正に関するお知らせ
...
| 6615 | UMC Electronics Co.,Lt | A | 7 | 株式会社豊田自動織 | 34.6 | 65 | 1.55 | 0.40 | 67 |
...
- Inputs: annual-report balance sheet, price cached 36d ago — screen-grade, not valuation-grade. 大株主 table reconciled against 1,418,000 issued shares, unit 百株
...
- Inputs: annual-report balance sheet, price cached 36d ago — screen-grade, not valuation-grade. 大株主 table reconciled against 15,637,144 issued shares, unit 千株
...
- Inputs: annual-report balance sheet, price cached 36d ago — screen-grade, not valuation-grade. 大株主 table reconciled against 22,500,000 issued shares, unit 千株
...
- Inputs: annual-report balance sheet, price cached 36d ago — screen-grade, not valuation-grade. 大株主 table reconciled against 15,630,000 issued shares, unit 千株
...
- Minority float ~49% of shares; the controller needs to reach 90% to squeeze out without an EGM.
- Inputs: annual-report balance sheet, price cached 36d ago — screen-grade, not valuation-grade. 大株主 table reconciled against 9,000,000 issued shares, unit 千株
...
- Inputs: annual-report balance sheet, price cached 36d ago — screen-grade, not valuation-grade. 大株主 table reconciled against 38,315,000 issued shares, unit 千株
...
- Inputs: annual-report balance sheet, price cached 36d ago — screen-grade, not valuation-grade. 大株主 table reconciled against 15,673,885 issued shares, unit 千株
...
- Inputs: annual-report balance sheet, price cached 36d ago — screen-grade, not valuation-grade. 大株主 table reconciled against 29,990,400 issued shares, unit 株
...
- Inputs: annual-report balance sheet, price cached 36d ago — screen-grade, not valuation-grade. 大株主 table reconciled against 135,452,804 issued shares, unit 千株
...
- Minority float ~49% of shares; the controller needs to reach 90% to squeeze out without an EGM.
- Inputs: annual-report balance sheet, price cached 36d ago — screen-grade, not valuation-grade. 大株主 table reconciled against 273,768,922 issued shares, unit 千株
