# Japan TOB / take-private lane — intake 2026-08-05

USD/JPY 157.63 at run. Announced book (spreads) and anticipatory book (fingerprints) are separate and are never summed.
...
40 deals tracked in the window; 10 live; 9 with a computable spread.

| target | name | bidder | offer ¥ | spot ¥ | gross % | ann. % | days | liquidity | timing |
|---|---|---|---|---|---|---|---|---|---|
| 4171 | グローバルＩ | 株式会社ユーザベース | 1,680 | 1,666 | +0.87 | +26 | 12 | THIN | DATED_STEP2 |
| 8283 | ＰＡＬＴＡＣ | メディパル | 6,650 | 6,630 | +0.30 | +14 | 8 | QUOTABLE | DATED_STEP2 |
| 2162 | ｎｍｓ　ＨＤ | ワールドＨＤ | 540 | 536 | +0.65 | +9 | 27 | THIN | DATED_STEP2 |
| 2997 | Ｇ－ストレージ王 | エリアリンク | 1,340 | 1,336 | +0.30 | +5 | 23 | QUOTABLE_SMALL | DATED |
| 3276 | ＪＰＭＣ | 株式会社Amsterdam1及び | 2,250 | 2,244 | +0.27 | +2 | 51 | QUOTABLE | DATED |
| 7523 | アールビバン | 株式会社Orsay | 1,900 | 1,898 | +0.13 | +2 | 27 | THIN | DATED |
| 4722 | フューチャー | 合同会社キーウェスト・ネットワー | 2,451 | 2,446 | +0.18 | +2 | 43 | QUOTABLE | DATED |
| 9110 | ユナイテド海 | 郵船 | 10,600 | 10,410 | +1.82 | — | — | QUOTABLE | TIMING_UNBOUNDED |
| 2371 | カカクコム | Kamgras1株式会社 | 3,450 | 3,701 | -6.78 | — | — | QUOTABLE | TIMING_UNBOUNDED |

### 4171 グローバルＩ — SQUEEZE_OUT

- **Bidder / purpose**: 株式会社ユーザベース · GO_PRIVATE · target opinion SUPPORT_AND_RECOMMEND
- **Terms**: offer ¥1,680 vs spot ¥1,666 = +0.87% gross
- **Timing**: DATED_STEP2 — step-2 cash-out effective 2026-08-17 (12d); delisting 2026-08-13
...
- **Liquidity (thin-print gate)**: THIN — 20d median turnover ¥2.6M/day — a quoted spread here is not fillable at size; this is a delisting stub, not a position
- **JPY add**: a ¥1,000,000 clip here is $6,344 of ADDITIONAL unhedged JPY on top of the existing Japan book.
- **Taxable**: tender proceeds are a disposition, not a rollover — short-term gain unless held >1y. On a +0.87% gross spread the after-tax return at a ~50% marginal rate is roughly half the headline.
- Source: https://www.release.tdnet.info/inbs/140120260713592081.pdf

### 8283 ＰＡＬＴＡＣ — SQUEEZE_OUT

- **Bidder / purpose**: メディパル · GO_PRIVATE · target opinion SUPPORT_AND_RECOMMEND
- **Terms**: offer ¥6,650 vs spot ¥6,630 = +0.30% gross
- **Timing**: DATED_STEP2 — step-2 cash-out effective 2026-08-13 (8d); delisting 2026-08-10
- **Minimum-tender condition**: no floor parsed — treat as UNVERIFIED, not as 'no condition'
- **Squeeze-out**: step 2 = 株式売渡請求 (Companies Act 179): available only at >=90% voting; ~1-2 months post-settlement, no EGM.
- **Liquidity (thin-print gate)**: QUOTABLE — 20d median turnover ¥726M/day
- **JPY add**: a ¥1,000,000 clip here is $6,344 of ADDITIONAL unhedged JPY on top of the existing Japan book.
- **Taxable**: tender proceeds are a disposition, not a rollover — short-term gain unless held >1y. On a +0.30% gross spread the after-tax return at a ~50% marginal rate is roughly half the headline.
- Source: https://www.release.tdnet.info/inbs/140120260715593845.pdf

### 2162 ｎｍｓ　ＨＤ — SQUEEZE_OUT

- **Bidder / purpose**: ワールドＨＤ · GO_PRIVATE · target opinion SUPPORT_AND_RECOMMEND
- **Terms**: offer ¥540 vs spot ¥536 = +0.65% gross
- **Timing**: DATED_STEP2 — step-2 cash-out effective 2026-09-01 (27d); delisting 2026-08-28
- **Minimum-tender condition**: no floor parsed — treat as UNVERIFIED, not as 'no condition'
- **Squeeze-out**: step 2 = 株式売渡請求 (Companies Act 179): available only at >=90% voting; ~1-2 months post-settlement, no EGM.
- **Liquidity (thin-print gate)**: THIN — 20d median turnover ¥6.8M/day — a quoted spread here is not fillable at size; this is a delisting stub, not a position
- **JPY add**: a ¥1,000,000 clip here is $6,344 of ADDITIONAL unhedged JPY on top of the existing Japan book.
- **Taxable**: tender proceeds are a disposition, not a rollover — short-term gain unless held >1y. On a +0.65% gross spread the after-tax return at a ~50% marginal rate is roughly half the headline.
- Source: https://www.release.tdnet.info/inbs/140120260727599733.pdf

### 2997 Ｇ－ストレージ王 — OPEN

- **Bidder / purpose**: エリアリンク · GO_PRIVATE · target opinion SUPPORT_AND_RECOMMEND
- **Terms**: offer ¥1,340 vs spot ¥1,336 = +0.30% gross
- **Timing**: DATED — cash expected 2026-08-28 (23d)
- **Minimum-tender condition**: floor 1,291,700 sh; post-deal ownership at the floor = 66.67%. If the floor is missed the offer FAILS: spread -> 0 and the stock re-rates to the un-bid level, so this is a two-sided, not a capped, risk.
...
- **Liquidity (thin-print gate)**: QUOTABLE_SMALL — 20d median turnover ¥70M/day — small clips only
- **JPY add**: a ¥1,000,000 clip here is $6,344 of ADDITIONAL unhedged JPY on top of the existing Japan book.
- **Taxable**: tender proceeds are a disposition, not a rollover — short-term gain unless held >1y. On a +0.30% gross spread the after-tax return at a ~50% marginal rate is roughly half the headline.
- Source: https://www.release.tdnet.info/inbs/140120260708590007.pdf
...
- **Timing**: DATED — cash expected 2026-09-25 (51d)
...
- **Squeeze-out**: step 2 = 株式併合 reverse split; requires an EGM special resolution, so a NON-tendering holder waits ~3-5 months beyond tender settlement for the same cash.
- **Liquidity (thin-print gate)**: QUOTABLE — 20d median turnover ¥230M/day
- **JPY add**: a ¥1,000,000 clip here is $6,344 of ADDITIONAL unhedged JPY on top of the existing Japan book.
...
- **Terms**: offer ¥1,900 vs spot ¥1,898 = +0.13% gross
- **Timing**: DATED — cash expected 2026-09-01 (27d)
...
- **Squeeze-out**: step 2 = 株式併合 reverse split; requires an EGM special resolution, so a NON-tendering holder waits ~3-5 months beyond tender settlement for the same cash.
- **Liquidity (thin-print gate)**: THIN — 20d median turnover ¥16.4M/day — a quoted spread here is not fillable at size; this is a delisting stub, not a position
- **JPY add**: a ¥1,000,000 clip here is $6,344 of ADDITIONAL unhedged JPY on top of the existing Japan book.
- **Taxable**: tender proceeds are a disposition, not a rollover — short-term gain unless held >1y. On a +0.13% gross spread the after-tax return at a ~50% marginal rate is roughly half the headline.
...
- **Terms**: offer ¥2,451 vs spot ¥2,446 = +0.18% gross
- **Timing**: DATED — cash expected 2026-09-17 (43d)
...
- **Squeeze-out**: step 2 = 株式併合 reverse split; requires an EGM special resolution, so a NON-tendering holder waits ~3-5 months beyond tender settlement for the same cash.
- **Liquidity (thin-print gate)**: QUOTABLE — 20d median turnover ¥2664M/day
- **JPY add**: a ¥1,000,000 clip here is $6,344 of ADDITIONAL unhedged JPY on top of the existing Japan book.
- **Taxable**: tender proceeds are a disposition, not a rollover — short-term gain unless held >1y. On a +0.18% gross spread the after-tax return at a ~50% marginal rate is roughly half the headline.
...
- **Terms**: offer ¥10,600 vs spot ¥10,410 = +1.82% gross
- **Timing**: TIMING_UNBOUNDED — offer is PRE-CONDITIONAL (competition clearance etc.); the commencement date is NOT fixed, so a computed annualized number would be manufactured. Gross only. SCENARIO ONLY: at 147d to cash (from the bidder's own guided commencement window (2026-11-25)) the gross +1.82% annualizes to +4%/yr — an assumption, NOT a term of the offer, and it goes to zero if the conditions fail.
...
- **Squeeze-out**: step 2 = 株式併合 reverse split; requires an EGM special resolution, so a NON-tendering holder waits ~3-5 months beyond tender settlement for the same cash.
- **Liquidity (thin-print gate)**: QUOTABLE — 20d median turnover ¥583M/day
- **JPY add**: a ¥1,000,000 clip here is $6,344 of ADDITIONAL unhedged JPY on top of the existing Japan book.
- **Taxable**: tender proceeds are a disposition, not a rollover — short-term gain unless held >1y. On a +1.82% gross spread the after-tax return at a ~50% marginal rate is roughly half the headline.
- Source: https://www.release.tdnet.info/inbs/140120260730503195.pdf

### Live but not priceable

- 4320 ＣＥＨＤ — TIMING_UNPARSED; QUOTABLE_SMALL; terms NOT parsed. SK-03株式会社による株式会社ＣＥホールディングスの株式（証券コード4320） に対する公開買付けの開始に関するお知らせ
...
|---|---|---|---|---|---|---|---|---|---|
| 9311 | ASAGAMI COPORATION | A | 9 | 株式会社オーエーコーポレーション | 52.5 | 47 | 0.65 | 0.49 | 88 |
| 4222 | KODAMA CHEMICAL INDUST | A | 8 | エンデバー・ユナイテッド | 52.1 | 48 | 1.25 | 0.34 | 66 |
| 6428 | OIZUMI Corporation | A | 8 | 株式会社オーイズミホールディングス | 47.2 | 53 | 1.13 | 0.38 | 83 |
| 4628 | SK KAKEN CO.,LTD. | B | 8 | 四国興産有限会 | 31.9 | 68 | 0.88 | 0.69 | 94 |
| 6964 | SANKO CO.,LTD. | A | 8 | 株式会社田村商事 | 51.2 | 49 | 0.79 | 0.38 | 65 |
| 7937 | TSUTSUMI JEWELRY CO.,L | A | 8 | 堤倭 | 51.2 | 49 | 0.79 | 0.59 | 61 |
| 8920 | TOSHO CO., LTD. | A | 8 | 沓名俊 | 43.7 | 56 | 0.70 | 0.78 | 75 |
| 9158 | 株式会社シーユーシー | A | 8 | エムスリー株式会社 | 63.5 | 37 | 0.64 | 0.74 | 52 |
| 5388 | KUNIMINE INDUSTRIES CO | A | 8 | クニミネエンタープライズ株式会社 | 40.3 | 60 | 0.64 | 0.68 | 52 |
| 3423 | SE Corporation | A | 8 | 有限会社エヌセック | 36.3 | 64 | 0.61 | 0.80 | 93 |
| 7238 | AKEBONO BRAKE INDUSTRY | A | 8 | ジャパン・インダストリアル・ソリューショ | 50.8 | 49 | 0.60 | 0.60 | 64 |
| 7222 | NISSAN SHATAI CO.,LTD. | A | 8 | 日産自動車株式会社 | 50.0 | 50 | 0.57 | 0.71 | 64 |
...
| 9115 | MEIJI SHIPPING GROUP C | B | 7 | 明治土地建物株式会 | 8.3 | 92 | 1.84 | 0.56 | 81 |
| 7297 | CAR MATE MFG.CO.,LTD | A | 7 | 有限会社エム・テイ興産 | 45.9 | 54 | 1.80 | 0.41 | — |
| 6615 | UMC Electronics Co.,Lt | A | 7 | 株式会社豊田自動織 | 34.6 | 65 | 1.62 | 0.38 | 66 |
| 6059 | UCHIYAMA HOLDINGS Co., | A | 7 | 内山文 | 44.4 | 56 | 1.51 | 0.51 | — |
| 9867 | Solekia Limited | B | 7 | フリージア・マクロス株式会社 | 30.1 | 70 | 1.44 | 0.68 | 77 |
| 3851 | NIPPON ICHI SOFTWARE I | A | 7 | 有限会社ローゼンクイーン商 | 46.3 | 54 | 1.41 | 0.58 | — |
| 7521 | MUSASHI CO.,LTD. | B | 7 | 上毛実業株式会社 | 20.4 | 80 | 1.11 | 0.57 | 83 |
| 5697 | SANYU CO.,LTD. | A | 7 | 日本製鉄株式会社 | 33.7 | 66 | 1.07 | 0.42 | 63 |
| 3103 | UNITIKA LTD. | A | 7 | 株式会社地域経済活性化支援機構 | 66.7 | 33 | 0.94 | 0.94 | 65 |
| 9229 | SUNWELS Co.,Ltd. | A | 7 | 株式会社杏 | 41.6 | 58 | 0.91 | 0.65 | 53 |
| 7991 | MAMIYA-OP CO.,LTD. | A | 7 | 株式会社データ・アート | 38.1 | 62 | 0.87 | 0.46 | 69 |
...
- cash = 65% of market cap — the target's own balance sheet funds much of the consideration, so the controller needs little outside money
- P/B 0.49 — below the TSE 1.0x line; taking in the minority below stated book is accretive to the acquirer on day one
- Minority float ~47% of shares; the controller needs to reach 90% to squeeze out without an EGM.
- Inputs: annual-report balance sheet, price cached 16d ago — screen-grade, not valuation-grade. 大株主 table reconciled against 1,418,000 issued shares, unit 百株
...
- cash = 125% of market cap — the target's own balance sheet funds much of the consideration, so the controller needs little outside money
...
- Inputs: annual-report balance sheet, price cached 16d ago — screen-grade, not valuation-grade. 大株主 table reconciled against 15,637,144 issued shares, unit 千株
...
- Inputs: annual-report balance sheet, price cached 16d ago — screen-grade, not valuation-grade. 大株主 table reconciled against 22,500,000 issued shares, unit 千株
...
- cash = 88% of market cap — the target's own balance sheet funds much of the consideration, so the controller needs little outside money
...
- Inputs: annual-report balance sheet, price cached 16d ago — screen-grade, not valuation-grade. 大株主 table reconciled against 15,673,885 issued shares, unit 千株
...
- Inputs: annual-report balance sheet, price cached 16d ago — screen-grade, not valuation-grade. 大株主 table reconciled against 9,000,000 issued shares, unit 千株
...
- cash = 78% of market cap — the target's own balance sheet funds much of the consideration, so the controller needs little outside money
- P/B 0.59 — below the TSE 1.0x line; taking in the minority below stated book is accretive to the acquirer on day one
- Minority float ~49% of shares; the controller needs to reach 90% to squeeze out without an EGM.
- Inputs: annual-report balance sheet, price cached 16d ago — screen-grade, not valuation-grade. 大株主 table reconciled against 15,630,000 issued shares, unit 千株
...
- lead director is 75 with no visible successor — a second, independent reason for the register to be resolved
- cash = 70% of market cap — the target's own balance sheet funds much of the consideration, so the controller needs little outside money
- P/B 0.78 — below the TSE 1.0x line; taking in the minority below stated book is accretive to the acquirer on day one
- Minority float ~56% of shares; the controller needs to reach 90% to squeeze out without an EGM.
- Inputs: annual-report balance sheet, price cached 16d ago — screen-grade, not valuation-grade. 大株主 table reconciled against 38,315,000 issued shares, unit 千株

### 9158 株式会社シーユーシー — A_PARENT_SUB, score 8
- エムスリー株式会社 holds 63.5% — a majority-controlled listed subsidiary. This is the exact cohort the TSE is pressuring to resolve, and the controller can execute a squeeze-out unilaterally once past 90%; note the filing declares NO statutory 親会社等, which at exactly 50.0% is legally consistent — control without the FIEA parent label
- cash = 64% of market cap — the target's own balance sheet funds much of the consideration, so the controller needs little outside money
- P/B 0.74 — below the TSE 1.0x line; taking in the minority below stated book is accretive to the acquirer on day one
- Minority float ~37% of shares; the controller needs to reach 90% to squeeze out without an EGM.
- Inputs: annual-report balance sheet, price cached 16d ago — screen-grade, not valuation-grade. 大株主 table reconciled against 29,990,400 issued shares, unit 株

### 5388 KUNIMINE INDUSTRIES CO.,LTD — A_PARENT_SUB, score 8
- クニミネエンタープライズ株式会社 holds 40.3% — above the one-third special-resolution blocking level. The holder already controls the outcome of any squeeze-out vote, so a top-up TOB is the cheapest route to 100%
- cash = 64% of market cap — the target's own balance sheet funds much of the consideration, so the controller needs little outside money
- P/B 0.68 — below the TSE 1.0x line; taking in the minority below stated book is accretive to the acquirer on day one
- the annual report itself carries 資本コスト / 株価を意識した経営 language — management is already on the TSE improvement track and has committed to closing the discount one way or another
- Minority float ~60% of shares; the controller needs to reach 90% to squeeze out without an EGM.
- Inputs: annual-report balance sheet, price cached 16d ago — screen-grade, not valuation-grade. 大株主 table reconciled against 14,450,000 issued shares, unit 千株

### 3423 SE Corporation — A_PARENT_SUB, score 8
- 有限会社エヌセック holds 36.3% — above the one-third special-resolution blocking level. The holder already controls the outcome of any squeeze-out vote, so a top-up TOB is the cheapest route to 100%
- lead director is 93 with no visible successor — a second, independent reason for the register to be resolved
- cash = 61% of market cap — the target's own balance sheet funds much of the consideration, so the controller needs little outside money
- P/B 0.80 — below the TSE 1.0x line; taking in the minority below stated book is accretive to the acquirer on day one
- Minority float ~64% of shares; the controller needs to reach 90% to squeeze out without an EGM.
- Inputs: annual-report balance sheet, price cached 16d ago — screen-grade, not valuation-grade. 大株主 table reconciled against 31,256,600 issued shares, unit 千株
