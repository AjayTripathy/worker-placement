# Japan TOB / take-private lane — intake 2026-08-31
...
53 deals tracked in the window; 15 live; 5 with a computable spread.

| target | name | bidder | offer ¥ | spot ¥ | gross % | ann. % | days | liquidity | timing |
|---|---|---|---|---|---|---|---|---|---|
| 2162 | ｎｍｓ　ＨＤ | ワールドＨＤ | 540 | 538 | +0.37 | +136 | 1 | THIN | DATED_STEP2 |
| 4722 | フューチャー | 合同会社キーウェスト・ネットワー | 2,451 | 2,449 | +0.08 | +2 | 17 | QUOTABLE | DATED |
| 3276 | ＪＰＭＣ | 株式会社Amsterdam1及び | 2,250 | 2,347 | -4.13 | -60 | 25 | QUOTABLE | DATED |
| 9110 | ユナイテド海 | 郵船 | 10,600 | 10,510 | +0.86 | — | — | QUOTABLE | TIMING_UNBOUNDED |
| 2371 | カカクコム | ＬＩＮＥヤフー | 3,450 | 3,667 | -5.92 | — | — | QUOTABLE | TIMING_UNBOUNDED |

### 2162 ｎｍｓ　ＨＤ — SQUEEZE_OUT

- **Bidder / purpose**: ワールドＨＤ · GO_PRIVATE · target opinion SUPPORT_AND_RECOMMEND
- **Terms**: offer ¥540 vs spot ¥538 = +0.37% gross
- **Timing**: DATED_STEP2 — step-2 cash-out effective 2026-09-01 (1d); delisting 2026-08-28
...
- **Taxable**: tender proceeds are a disposition, not a rollover — short-term gain unless held >1y. On a +0.37% gross spread the after-tax return at a ~50% marginal rate is roughly half the headline.
...
- **Terms**: offer ¥2,451 vs spot ¥2,449 = +0.08% gross
- **Timing**: DATED — cash expected 2026-09-17 (17d)
...
- **Liquidity (thin-print gate)**: QUOTABLE — 20d median turnover ¥2706M/day
- **JPY add**: a ¥1,000,000 clip here is $6,265 of ADDITIONAL unhedged JPY on top of the existing Japan book.
...
- **Terms**: offer ¥2,250 vs spot ¥2,347 = -4.13% gross
- **Timing**: DATED — cash expected 2026-09-25 (25d)
...
- **Squeeze-out**: step 2 = 株式併合 reverse split; requires an EGM special resolution, so a NON-tendering holder waits ~3-5 months beyond tender settlement for the same cash.
- **Liquidity (thin-print gate)**: QUOTABLE — 20d median turnover ¥598M/day
- **JPY add**: a ¥1,000,000 clip here is $6,265 of ADDITIONAL unhedged JPY on top of the existing Japan book.
- **Taxable**: tender proceeds are a disposition, not a rollover — short-term gain unless held >1y. On a -4.13% gross spread the after-tax return at a ~50% marginal rate is roughly half the headline.
...
- **Terms**: offer ¥10,600 vs spot ¥10,510 = +0.86% gross
- **Timing**: TIMING_UNBOUNDED — offer is PRE-CONDITIONAL (competition clearance etc.); the commencement date is NOT fixed, so a computed annualized number would be manufactured. Gross only. SCENARIO ONLY: at 121d to cash (from the bidder's own guided commencement window (2026-11-25)) the gross +0.86% annualizes to +3%/yr — an assumption, NOT a term of the offer, and it goes to zero if the conditions fail.
...
- **Squeeze-out**: step 2 = 株式併合 reverse split; requires an EGM special resolution, so a NON-tendering holder waits ~3-5 months beyond tender settlement for the same cash.
- **Liquidity (thin-print gate)**: QUOTABLE — 20d median turnover ¥1386M/day
- **JPY add**: a ¥1,000,000 clip here is $6,265 of ADDITIONAL unhedged JPY on top of the existing Japan book.
- **Taxable**: tender proceeds are a disposition, not a rollover — short-term gain unless held >1y. On a +0.86% gross spread the after-tax return at a ~50% marginal rate is roughly half the headline.
...
- **Squeeze-out**: step 2 = 株式併合 reverse split; requires an EGM special resolution, so a NON-tendering holder waits ~3-5 months beyond tender settlement for the same cash.
- **Liquidity (thin-print gate)**: QUOTABLE — 20d median turnover ¥917M/day
- **JPY add**: a ¥1,000,000 clip here is $6,265 of ADDITIONAL unhedged JPY on top of the existing Japan book.
- **Taxable**: tender proceeds are a disposition, not a rollover — short-term gain unless held >1y. On a -5.92% gross spread the after-tax return at a ~50% marginal rate is roughly half the headline.
...
- **8283 ＰＡＬＴＡＣ** — headline +0.30% vs offer ¥6,650. not quotable: last print 24d old — spread struck on a stale tape
- **4171 グローバルＩ** — headline +0.90% vs offer ¥1,680. not quotable: last print 19d old — spread struck on a stale tape
...
- 7743 シード — TIMING_UNPARSED; THIN; terms NOT parsed. ラックスシェア・プレシジョン・ケイマン・リミテッドによる当社株式に対する公開買付けに関する賛同の意見表明及び応募推奨に関するお知らせ
- 4812 電通総研 — TIMING_UNPARSED; QUOTABLE; terms NOT parsed. 合同会社VICによる当社株式に対する公開買付けの開始予定に関する賛同の意見表明及び応募推奨に関するお知らせ
- 6897 ツインバード — TIMING_UNPARSED; THIN; terms NOT parsed. 株式会社ジャパネットホールディングスによる当社株式に対する 公開買付けの開始予定に関する反対の意見表明のお知らせ
...
| 6615 | UMC Electronics Co.,Lt | A | 7 | 株式会社豊田自動織 | 34.6 | 65 | 1.59 | 0.39 | 67 |
...
- Inputs: annual-report balance sheet, price cached 10d ago — screen-grade, not valuation-grade. 大株主 table reconciled against 1,418,000 issued shares, unit 百株
...
- Inputs: annual-report balance sheet, price cached 10d ago — screen-grade, not valuation-grade. 大株主 table reconciled against 15,637,144 issued shares, unit 千株
...
- Inputs: annual-report balance sheet, price cached 10d ago — screen-grade, not valuation-grade. 大株主 table reconciled against 22,500,000 issued shares, unit 千株
...
- Inputs: annual-report balance sheet, price cached 10d ago — screen-grade, not valuation-grade. 大株主 table reconciled against 15,630,000 issued shares, unit 千株
...
- Minority float ~49% of shares; the controller needs to reach 90% to squeeze out without an EGM.
- Inputs: annual-report balance sheet, price cached 10d ago — screen-grade, not valuation-grade. 大株主 table reconciled against 9,000,000 issued shares, unit 千株
...
- Inputs: annual-report balance sheet, price cached 10d ago — screen-grade, not valuation-grade. 大株主 table reconciled against 38,315,000 issued shares, unit 千株
...
- Inputs: annual-report balance sheet, price cached 10d ago — screen-grade, not valuation-grade. 大株主 table reconciled against 15,673,885 issued shares, unit 千株
...
- Inputs: annual-report balance sheet, price cached 10d ago — screen-grade, not valuation-grade. 大株主 table reconciled against 29,990,400 issued shares, unit 株
...
- Minority float ~49% of shares; the controller needs to reach 90% to squeeze out without an EGM.
- Inputs: annual-report balance sheet, price cached 10d ago — screen-grade, not valuation-grade. 大株主 table reconciled against 273,768,922 issued shares, unit 千株
...
- Inputs: annual-report balance sheet, price cached 10d ago — screen-grade, not valuation-grade. 大株主 table reconciled against 135,452,804 issued shares, unit 千株
