# Japan TOB / take-private lane — intake 2026-08-27

USD/JPY 159.45 at run. Announced book (spreads) and anticipatory book (fingerprints) are separate and are never summed.
...
50 deals tracked in the window; 13 live; 5 with a computable spread.

| target | name | bidder | offer ¥ | spot ¥ | gross % | ann. % | days | liquidity | timing |
|---|---|---|---|---|---|---|---|---|---|
| 2162 | ｎｍｓ　ＨＤ | ワールドＨＤ | 540 | 538 | +0.37 | +27 | 5 | THIN | DATED_STEP2 |
| 3276 | ＪＰＭＣ | 株式会社Amsterdam1及び | 2,250 | 2,246 | +0.18 | +2 | 29 | QUOTABLE | DATED |
| 4722 | フューチャー | 合同会社キーウェスト・ネットワー | 2,451 | 2,450 | +0.04 | +1 | 21 | QUOTABLE | DATED |
| 9110 | ユナイテド海 | 郵船 | 10,600 | 10,470 | +1.24 | — | — | QUOTABLE | TIMING_UNBOUNDED |
| 2371 | カカクコム | ＬＩＮＥヤフー | 3,450 | 3,673 | -6.07 | — | — | QUOTABLE | TIMING_UNBOUNDED |
...
- **Timing**: DATED_STEP2 — step-2 cash-out effective 2026-09-01 (5d); delisting 2026-08-28
...
- **JPY add**: a ¥1,000,000 clip here is $6,272 of ADDITIONAL unhedged JPY on top of the existing Japan book.
...
- **Timing**: DATED — cash expected 2026-09-25 (29d)
...
- **Terms**: offer ¥2,451 vs spot ¥2,450 = +0.04% gross
- **Timing**: DATED — cash expected 2026-09-17 (21d)
...
- **Squeeze-out**: step 2 = 株式併合 reverse split; requires an EGM special resolution, so a NON-tendering holder waits ~3-5 months beyond tender settlement for the same cash.
- **Liquidity (thin-print gate)**: QUOTABLE — 20d median turnover ¥2890M/day
- **JPY add**: a ¥1,000,000 clip here is $6,272 of ADDITIONAL unhedged JPY on top of the existing Japan book.
...
- **Squeeze-out**: step 2 = 株式併合 reverse split; requires an EGM special resolution, so a NON-tendering holder waits ~3-5 months beyond tender settlement for the same cash.
- **Liquidity (thin-print gate)**: QUOTABLE — 20d median turnover ¥944M/day
- **JPY add**: a ¥1,000,000 clip here is $6,272 of ADDITIONAL unhedged JPY on top of the existing Japan book.
- **Taxable**: tender proceeds are a disposition, not a rollover — short-term gain unless held >1y. On a -6.07% gross spread the after-tax return at a ~50% marginal rate is roughly half the headline.
...
- **8283 ＰＡＬＴＡＣ** — headline +0.30% vs offer ¥6,650. not quotable: last print 20d old — spread struck on a stale tape
- **4171 グローバルＩ** — headline +0.90% vs offer ¥1,680. not quotable: last print 15d old — spread struck on a stale tape
