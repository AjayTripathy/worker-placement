# Japan TOB / take-private lane — intake 2026-08-07

USD/JPY 157.58 at run. Announced book (spreads) and anticipatory book (fingerprints) are separate and are never summed.
...
41 deals tracked in the window; 11 live; 9 with a computable spread.

| target | name | bidder | offer ¥ | spot ¥ | gross % | ann. % | days | liquidity | timing |
|---|---|---|---|---|---|---|---|---|---|
| 4171 | グローバルＩ | 株式会社ユーザベース | 1,680 | 1,666 | +0.87 | +32 | 10 | THIN | DATED_STEP2 |
| 8283 | ＰＡＬＴＡＣ | メディパル | 6,650 | 6,635 | +0.23 | +14 | 6 | QUOTABLE | DATED_STEP2 |
| 2162 | ｎｍｓ　ＨＤ | ワールドＨＤ | 540 | 536 | +0.65 | +10 | 25 | THIN | DATED_STEP2 |
| 2997 | Ｇ－ストレージ王 | エリアリンク | 1,340 | 1,336 | +0.34 | +6 | 21 | QUOTABLE_SMALL | DATED |
| 3276 | ＪＰＭＣ | 株式会社Amsterdam1及び | 2,250 | 2,244 | +0.24 | +2 | 49 | QUOTABLE | DATED |
| 4722 | フューチャー | 合同会社キーウェスト・ネットワー | 2,451 | 2,446 | +0.18 | +2 | 41 | QUOTABLE | DATED |
| 7523 | アールビバン | 株式会社Orsay | 1,900 | 1,898 | +0.08 | +1 | 25 | THIN | DATED |
| 9110 | ユナイテド海 | 郵船 | 10,600 | 10,465 | +1.29 | — | — | QUOTABLE | TIMING_UNBOUNDED |
| 2371 | カカクコム | Kamgras1株式会社 | 3,450 | 3,725 | -7.38 | — | — | QUOTABLE | TIMING_UNBOUNDED |
...
- **Timing**: DATED_STEP2 — step-2 cash-out effective 2026-08-17 (10d); delisting 2026-08-13
...
- **JPY add**: a ¥1,000,000 clip here is $6,346 of ADDITIONAL unhedged JPY on top of the existing Japan book.
...
- **Terms**: offer ¥6,650 vs spot ¥6,635 = +0.23% gross
- **Timing**: DATED_STEP2 — step-2 cash-out effective 2026-08-13 (6d); delisting 2026-08-10
- **Minimum-tender condition**: no floor parsed — treat as UNVERIFIED, not as 'no condition'
- **Squeeze-out**: step 2 = 株式売渡請求 (Companies Act 179): available only at >=90% voting; ~1-2 months post-settlement, no EGM.
- **Liquidity (thin-print gate)**: QUOTABLE — 20d median turnover ¥773M/day
- **JPY add**: a ¥1,000,000 clip here is $6,346 of ADDITIONAL unhedged JPY on top of the existing Japan book.
- **Taxable**: tender proceeds are a disposition, not a rollover — short-term gain unless held >1y. On a +0.23% gross spread the after-tax return at a ~50% marginal rate is roughly half the headline.
...
- **Timing**: DATED_STEP2 — step-2 cash-out effective 2026-09-01 (25d); delisting 2026-08-28
- **Minimum-tender condition**: no floor parsed — treat as UNVERIFIED, not as 'no condition'
- **Squeeze-out**: step 2 = 株式売渡請求 (Companies Act 179): available only at >=90% voting; ~1-2 months post-settlement, no EGM.
- **Liquidity (thin-print gate)**: THIN — 20d median turnover ¥6.5M/day — a quoted spread here is not fillable at size; this is a delisting stub, not a position
- **JPY add**: a ¥1,000,000 clip here is $6,346 of ADDITIONAL unhedged JPY on top of the existing Japan book.
...
- **Terms**: offer ¥1,340 vs spot ¥1,336 = +0.34% gross
- **Timing**: DATED — cash expected 2026-08-28 (21d)
...
- **JPY add**: a ¥1,000,000 clip here is $6,346 of ADDITIONAL unhedged JPY on top of the existing Japan book.
- **Taxable**: tender proceeds are a disposition, not a rollover — short-term gain unless held >1y. On a +0.34% gross spread the after-tax return at a ~50% marginal rate is roughly half the headline.
...
- **Terms**: offer ¥2,250 vs spot ¥2,244 = +0.24% gross
- **Timing**: DATED — cash expected 2026-09-25 (49d)
...
- **Squeeze-out**: step 2 = 株式併合 reverse split; requires an EGM special resolution, so a NON-tendering holder waits ~3-5 months beyond tender settlement for the same cash.
- **Liquidity (thin-print gate)**: QUOTABLE — 20d median turnover ¥289M/day
- **JPY add**: a ¥1,000,000 clip here is $6,346 of ADDITIONAL unhedged JPY on top of the existing Japan book.
- **Taxable**: tender proceeds are a disposition, not a rollover — short-term gain unless held >1y. On a +0.24% gross spread the after-tax return at a ~50% marginal rate is roughly half the headline.
...
- **Timing**: DATED — cash expected 2026-09-17 (41d)
...
- **Squeeze-out**: step 2 = 株式併合 reverse split; requires an EGM special resolution, so a NON-tendering holder waits ~3-5 months beyond tender settlement for the same cash.
- **Liquidity (thin-print gate)**: QUOTABLE — 20d median turnover ¥3248M/day
- **JPY add**: a ¥1,000,000 clip here is $6,346 of ADDITIONAL unhedged JPY on top of the existing Japan book.
...
- **Terms**: offer ¥1,900 vs spot ¥1,898 = +0.08% gross
- **Timing**: DATED — cash expected 2026-09-01 (25d)
...
- **Squeeze-out**: step 2 = 株式併合 reverse split; requires an EGM special resolution, so a NON-tendering holder waits ~3-5 months beyond tender settlement for the same cash.
- **Liquidity (thin-print gate)**: THIN — 20d median turnover ¥16.8M/day — a quoted spread here is not fillable at size; this is a delisting stub, not a position
- **JPY add**: a ¥1,000,000 clip here is $6,346 of ADDITIONAL unhedged JPY on top of the existing Japan book.
- **Taxable**: tender proceeds are a disposition, not a rollover — short-term gain unless held >1y. On a +0.08% gross spread the after-tax return at a ~50% marginal rate is roughly half the headline.
...
- **Terms**: offer ¥10,600 vs spot ¥10,465 = +1.29% gross
- **Timing**: TIMING_UNBOUNDED — offer is PRE-CONDITIONAL (competition clearance etc.); the commencement date is NOT fixed, so a computed annualized number would be manufactured. Gross only. SCENARIO ONLY: at 145d to cash (from the bidder's own guided commencement window (2026-11-25)) the gross +1.29% annualizes to +3%/yr — an assumption, NOT a term of the offer, and it goes to zero if the conditions fail.
...
- **Squeeze-out**: step 2 = 株式併合 reverse split; requires an EGM special resolution, so a NON-tendering holder waits ~3-5 months beyond tender settlement for the same cash.
- **Liquidity (thin-print gate)**: QUOTABLE — 20d median turnover ¥651M/day
- **JPY add**: a ¥1,000,000 clip here is $6,346 of ADDITIONAL unhedged JPY on top of the existing Japan book.
- **Taxable**: tender proceeds are a disposition, not a rollover — short-term gain unless held >1y. On a +1.29% gross spread the after-tax return at a ~50% marginal rate is roughly half the headline.
...
- 3676 デジハＨＤ — TIMING_UNPARSED; LIMIT_LOCKED; terms NOT parsed. 株式会社デジタルハーツホールディングス（証券コード：3676）に対する公開買付けの開始に関するお知らせ
...
| 8920 | TOSHO CO., LTD. | A | 8 | 沓名俊 | 43.7 | 56 | 0.79 | 0.69 | 75 |
...
- Inputs: annual-report balance sheet, price cached 1d ago — screen-grade, not valuation-grade. 大株主 table reconciled against 1,418,000 issued shares, unit 百株
...
- Inputs: annual-report balance sheet, price cached 1d ago — screen-grade, not valuation-grade. 大株主 table reconciled against 15,637,144 issued shares, unit 千株
...
- Inputs: annual-report balance sheet, price cached 1d ago — screen-grade, not valuation-grade. 大株主 table reconciled against 22,500,000 issued shares, unit 千株
...
- Inputs: annual-report balance sheet, price cached 1d ago — screen-grade, not valuation-grade. 大株主 table reconciled against 15,630,000 issued shares, unit 千株
...
- Minority float ~49% of shares; the controller needs to reach 90% to squeeze out without an EGM.
- Inputs: annual-report balance sheet, price cached 1d ago — screen-grade, not valuation-grade. 大株主 table reconciled against 9,000,000 issued shares, unit 千株
...
- Inputs: annual-report balance sheet, price cached 1d ago — screen-grade, not valuation-grade. 大株主 table reconciled against 38,315,000 issued shares, unit 千株
...
- Inputs: annual-report balance sheet, price cached 1d ago — screen-grade, not valuation-grade. 大株主 table reconciled against 15,673,885 issued shares, unit 千株
...
- Inputs: annual-report balance sheet, price cached 1d ago — screen-grade, not valuation-grade. 大株主 table reconciled against 29,990,400 issued shares, unit 株
...
- Inputs: annual-report balance sheet, price cached 1d ago — screen-grade, not valuation-grade. 大株主 table reconciled against 135,452,804 issued shares, unit 千株
...
- Minority float ~49% of shares; the controller needs to reach 90% to squeeze out without an EGM.
- Inputs: annual-report balance sheet, price cached 1d ago — screen-grade, not valuation-grade. 大株主 table reconciled against 273,768,922 issued shares, unit 千株
