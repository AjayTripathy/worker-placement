# Japan TOB / take-private lane — intake 2026-08-21

USD/JPY 159.02 at run. Announced book (spreads) and anticipatory book (fingerprints) are separate and are never summed.
...
|---|---|---|---|---|---|---|---|---|---|
| 2997 | Ｇ－ストレージ王 | エリアリンク | 1,340 | 1,324 | +1.17 | +61 | 7 | QUOTABLE_SMALL | DATED |
| 2162 | ｎｍｓ　ＨＤ | ワールドＨＤ | 540 | 536 | +0.65 | +22 | 11 | THIN | DATED_STEP2 |
| 4722 | フューチャー | 合同会社キーウェスト・ネットワー | 2,451 | 2,446 | +0.20 | +3 | 27 | QUOTABLE | DATED |
| 3276 | ＪＰＭＣ | 株式会社Amsterdam1及び | 2,250 | 2,244 | +0.24 | +3 | 35 | QUOTABLE | DATED |
| 7523 | アールビバン | 株式会社Orsay | 1,900 | 1,899 | +0.05 | +2 | 11 | THIN | DATED |
| 9110 | ユナイテド海 | 郵船 | 10,600 | 10,450 | +1.44 | — | — | QUOTABLE | TIMING_UNBOUNDED |
| 2371 | カカクコム | ＬＩＮＥヤフー | 3,450 | 3,690 | -6.52 | — | — | QUOTABLE | TIMING_UNBOUNDED |

### 2997 Ｇ－ストレージ王 — OPEN

- **Bidder / purpose**: エリアリンク · GO_PRIVATE · target opinion SUPPORT_AND_RECOMMEND
- **Terms**: offer ¥1,340 vs spot ¥1,324 = +1.17% gross
- **Timing**: DATED — cash expected 2026-08-28 (7d)
...
- **JPY add**: a ¥1,000,000 clip here is $6,289 of ADDITIONAL unhedged JPY on top of the existing Japan book.
- **Taxable**: tender proceeds are a disposition, not a rollover — short-term gain unless held >1y. On a +1.17% gross spread the after-tax return at a ~50% marginal rate is roughly half the headline.
...
- **Timing**: DATED_STEP2 — step-2 cash-out effective 2026-09-01 (11d); delisting 2026-08-28
...
- **Timing**: DATED — cash expected 2026-09-17 (27d)
...
- **Timing**: DATED — cash expected 2026-09-25 (35d)
...
- **Timing**: DATED — cash expected 2026-09-01 (11d)
...
- **Squeeze-out**: step 2 = 株式併合 reverse split; requires an EGM special resolution, so a NON-tendering holder waits ~3-5 months beyond tender settlement for the same cash.
- **Liquidity (thin-print gate)**: THIN — 20d median turnover ¥10.4M/day — a quoted spread here is not fillable at size; this is a delisting stub, not a position
- **JPY add**: a ¥1,000,000 clip here is $6,289 of ADDITIONAL unhedged JPY on top of the existing Japan book.
...
- **Timing**: TIMING_UNBOUNDED — offer is PRE-CONDITIONAL (competition clearance etc.); the commencement date is NOT fixed, so a computed annualized number would be manufactured. Gross only. SCENARIO ONLY: at 131d to cash (from the bidder's own guided commencement window (2026-11-25)) the gross +1.44% annualizes to +4%/yr — an assumption, NOT a term of the offer, and it goes to zero if the conditions fail.
...
- **Squeeze-out**: step 2 = 株式併合 reverse split; requires an EGM special resolution, so a NON-tendering holder waits ~3-5 months beyond tender settlement for the same cash.
- **Liquidity (thin-print gate)**: QUOTABLE — 20d median turnover ¥1124M/day
- **JPY add**: a ¥1,000,000 clip here is $6,289 of ADDITIONAL unhedged JPY on top of the existing Japan book.
- **Taxable**: tender proceeds are a disposition, not a rollover — short-term gain unless held >1y. On a -6.52% gross spread the after-tax return at a ~50% marginal rate is roughly half the headline.
...
- **8283 ＰＡＬＴＡＣ** — headline +0.30% vs offer ¥6,650. not quotable: last print 14d old — spread struck on a stale tape
- **4171 グローバルＩ** — headline +0.90% vs offer ¥1,680. not quotable: last print 9d old — spread struck on a stale tape
