...
OPT = {
    ...
    "daf_gift":   ("Review appreciated-share giving (DAF / charity)", "GIFT", "Potential deduction and avoided gain on donated shares",
                   lambda X: ("Gift amount leaves the portfolio", "verify lots, recipient eligibility, deduction limits and transfer timing before modeling tax benefits")),
