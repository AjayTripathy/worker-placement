...
Extras: `ai` installs the Anthropic client; `ibkr` remains a compatibility extra. IBKR, Robinhood and TOTP clients are included in the base distribution. Install extras against the assembled path, for example `python3 -m pip install './officekit_dist/build[ai,ibkr]'`.
