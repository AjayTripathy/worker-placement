...
description: >
  Tracks sector and issuer developments, synthesizes news/filings/broker research, and flags items
  for credit and risk review. SignalOS-augmented: adds physical-truth alt-data (satellite buildout,
  methane, federal procurement) to verify the narrative against reality, not just aggregate it.
---
